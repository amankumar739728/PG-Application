...
FROM_EMAIL = os.environ.get("MAIL_FROM", SMTP_USERNAME)
...
def send_payment_reminder_email(to_email, guest_name, room_number, payment_details):
    ...
    - payment_details: Dict containing payment info including payment_type ('rent' or 'security')
    """
    try:
        # Create message
        ...
        msg['From'] = FROM_EMAIL
        msg['To'] = to_email
        msg['Subject'] = f"Payment Reminder - Room {room_number}"
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>This is a friendly reminder about your upcoming rent payment. We appreciate your prompt attention to this matter.</p>
            ...
            <div class="payment-details">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">₹{payment_details.get('balance_amount', 0):,}</span>
                </div>
            </div>

            <div class="warning-box">
                <h3>⚠️ Important Notice</h3>
                <p>Please ensure your payment is completed before the 5th of every month to avoid any late fees or service interruptions.</p>
            </div>
            ...
            <div class="contact-info">
                ...
                <p><strong>Email:</strong> support@pgtracker.com</p>
            </div>

            <p>Thank you for your continued partnership and for keeping your payments up to date.</p>
...
PAYMENT REMINDER - Room {room_number}

This is a friendly reminder about your upcoming rent payment.

PAYMENT DETAILS:
- Room Number: {room_number}
- Payment Month: {payment_details.get('payment_month', 'N/A')}
- Amount Due: ₹{payment_details.get('amount', 0):,}
- Balance Amount: ₹{payment_details.get('balance_amount', 0):,}

IMPORTANT: Please ensure your payment is completed before the 5th of every month to avoid any late fees.

If you have any questions, please contact us at support@pgtracker.com or +91-XXXXXXXXXX.
...
def send_overdue_payment_email(to_email, guest_name, room_number, payment_details, days_overdue):
    """
    Send overdue payment notification email to guest
    ...
    try:
        ...
        msg['From'] = FROM_EMAIL
        msg['To'] = to_email
        msg['Subject'] = f"🚨 OVERDUE PAYMENT NOTICE - Room {room_number}"
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="contact-info">
                <h4 style="margin-top: 0; color: #495057;">📞 Need Assistance?</h4>
                <p>If you have any questions or need help with your payment, please contact us immediately.</p>
                <p><strong>Phone:</strong> +91-XXXXXXXXXX</p>
                <p><strong>Email:</strong> support@pgtracker.com</p>
...
URGENT OVERDUE PAYMENT NOTICE - Room {room_number}

Your rent payment is currently OVERDUE by {days_overdue} days.
...
Please make your payment immediately to avoid additional late fees and service interruptions.

IMPORTANT NOTICE:
Failure to make payment within the next 7 days may result in additional charges and could affect your accommodation status.

If you have any questions or need assistance with your payment, please contact us immediately at:
- Phone: +91-7397289262
- Email: support@pgtracker.com
- Emergency Contact: Available 24/7

We value you as a resident and appreciate your prompt attention to this matter.
...
---
PG Tracker System
This is an urgent automated notification. Please respond immediately.
"""
...
def send_monthly_rent_reminder_email(to_email, guest_name, room_number, payment_details):
    """
    Send monthly rent reminder email to guest (gentle reminder on 5th of each month)
    ...
    try:
        ...
        msg['From'] = FROM_EMAIL
        msg['To'] = to_email
        msg['Subject'] = f"📅 Monthly Rent Reminder - Room {room_number}"
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Monthly Rent Reminder</title>
    <style>
        body {{
            font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
            line-height: 1.6;
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="payment-details">
                ...
                <div class="detail-row">
                    <span class="detail-label">Payment Month:</span>
                    <span class="detail-value">{payment_details.get('payment_month', 'N/A')} {payment_details.get('payment_year', datetime.datetime.now().year)}</span>
                </div>

                <div class="detail-row">
                    <span class="detail-label">Monthly Rent:</span>
                    <span class="detail-value amount-highlight">₹{payment_details.get('rent_amount', 0):,}</span>
                </div>
            </div>
            ...
            <div class="contact-info">
                <h4 style="margin-top: 0; color: #495057;">📞 Need Assistance?</h4>
                <p>If you have any questions or need help with your payment, please don't hesitate to contact us.</p>
                <p><strong>Phone:</strong> +91-XXXXXXXXXX</p>
                <p><strong>Email:</strong> support@pgtracker.com</p>
            </div>
...
MONTHLY RENT REMINDER - Room {room_number}

This is a gentle reminder that your monthly rent payment is due.

PAYMENT DETAILS:
- Room Number: {room_number}
- Payment Month: {payment_details.get('payment_month', 'N/A')} {payment_details.get('payment_year', datetime.datetime.now().year)}
- Monthly Rent: ₹{payment_details.get('rent_amount', 0):,}

PAYMENT INFORMATION:
Your rent payment is typically due by the 5th of each month. Please ensure timely payment to avoid any late fees.
